...
public:
    explicit SphereProjector(glm::dvec3 tangent_point) {
        ...
        const glm::dvec3 b = glm::cross(a, not_parallel_to_normal);
    ...
    glm::dvec2 project_point(const glm::dvec3 &cartesian) const {
        ...
        const glm::dvec3 rotated = rotation * glm::normalize(cartesian);
...
private:
    static glm::dvec2 cartesian_to_lon_lat(const glm::dvec3 &point) {
    ...
    static glm::dvec3 lon_lat_to_cartesian(const glm::dvec2 &lon_lat) {
